...
public class StafController {
	...
	@PostMapping("/staf")
	public ResponseEntity<String> createStaf(@RequestBody @Valid StafEntity stafEntity) {
		StafEntity savedStaf = service.create(stafEntity);
	...
	public ResponseEntity<StafEntity> update(@RequestBody @Valid StafEntity stafEntity,
			@PathVariable("id") Integer id) {
		StafEntity savedStaf = service.updateId(id, stafEntity);
		return ResponseEntity.ok(savedStaf);
	}
